...
const { hashPassword, verifyPassword } = require('../shared/database');
const { hashToken, generateSecureToken } = require('../shared/crypto');
const jwt = require('jsonwebtoken');
const multer = require('multer');
const nodemailer = require('nodemailer');
const database = require('../shared/database');
const { PayoutService } = require('../shared/payout');
...
const PORT = process.env.PUBLIC_API_PORT || 3003;
...
app.post('/api/auth/register', 
  ...
  try {
    ...
    const result = await database.run(
      `INSERT INTO users (role, email, password_hash, name, company_name, phone, age, skills, resume_url, experience, available_hours, approved, verification_code, verified, experience_years)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 1, ?)`,
      [
        role,
        email,
